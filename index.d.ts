...
export declare function imagesToTiffWithCompression(images: ArrayLike<ImageData>, compress: (imageData: ImageData) => readonly [number, ArrayBufferLike] | Promise<readonly [number, ArrayBufferLike]>, options?: ImagesToTiffOptions): Promise<Uint8Array>;
